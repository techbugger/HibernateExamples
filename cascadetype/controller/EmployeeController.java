...
public class EmployeeController 
{
    ...
    @PostMapping("/test")
    public HttpStatus createEmployee(@RequestBody EmployeeEntity employee)
                                                    throws Exception {
    	Logging.info("Inserting Request Received Test");
        EmployeeEntityTest updated = service.createEmployee(employee);
